...
public class MatchPersistenceAdapter implements MatchRepositoryPort {
    ...
    private Match toDomain(MatchEntity entity) {
        ...
        return Match.builder()
                ...
                .qualifierOddsJson(entity.getQualifierOddsJson())
                .qualificationMethod(entity.getQualificationMethod())
    ...
    private MatchEntity toEntity(Match domain) {
        ...
        return MatchEntity.builder()
                ...
                .qualifierOddsJson(domain.getQualifierOddsJson())
                .qualificationMethod(domain.getQualificationMethod())
