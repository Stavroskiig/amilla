      ...
      <div className="card glass" style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
        ...
        <div>
          ...
          <ul style={{ color: '#e5e7eb', lineHeight: '1.8', paddingLeft: '1.5rem', marginBottom: '1.5rem' }}>
            ...
            <li>
              <strong style={{ color: '#f472b6' }}>Πρόκριση (στα Νοκ-Άουτ):</strong> Στα νοκ-άουτ, αν προβλέψετε σωστά την ομάδα που προκρίνεται, μπορείτε να κερδίσετε μπόνους πρόκρισης (<code>10 × Απόδοση Πρόκρισης</code>):
          ...
          <p style={{ marginTop: '1rem', fontSize: '0.9rem', color: '#9ca3af', fontStyle: 'italic' }}>
            * Σημείωση: Αν πετύχετε το ακριβές σκορ, λαμβάνετε <strong>μόνο</strong> τους πόντους του ακριβούς σκορ. Δεν αθροίζονται με τους πόντους του σημείου. Εξαιρούνται οι νοκ-άουτ αγώνες.
          </p>
        </div>
      </div>
    </div>
